    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-list"></span> 我的物品管理
            </div>
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (val, r) {
                    var _html = '';
                    if (r.isReview == 'Y') {
                        _html += '<a class="am-icon-list" style="margin: 0 3px;color:#32c5d2" href="<%=basePath %>ck/ck/list?id=' + r.id + '" title="库存管理"></a>';
                    }
                    _html += '<a class="am-icon-edit" style="margin: 0 3px;color:#32c5d2" href="<%=basePath %>goods/goods/edit?id=' + r.id + '" title="编辑"></a>' +
                        '<a class="am-icon-trash"  style="margin: 0 3px;color:#32c5d2" onclick="deleteGoods(' + r.id + ')"  title="删除"></a>';
                    return _html;
