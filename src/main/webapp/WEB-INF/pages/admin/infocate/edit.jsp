                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-12">
                            <form class="am-form am-form-horizontal" action="<%=basePath %>infocate/infocate/update" method="POST">
                               ...
                               <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">性质</label>
                                    <div class="am-u-sm-9">
                                        <input type="radio" <c:if test="${model.type==1 }">checked</c:if> name="type" value="1" > 物品类别
                                        <input type="radio" <c:if test="${model.type==2 }">checked</c:if>  name="type" value="2" > 信息类别
                                        <small></small>
                                    </div>
                                </div>
