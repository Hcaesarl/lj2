...
<body>
              ...
              <div class="admin-content am-u-lg-6 am-cf am-padding am-padding-bottom-0" style="padding:15px;width: 100%">
                ...
                <div class="big-box">
                  <div class="col-lg-6">
                    ...
                    <form method="POST"  action="<%=basePath%>fixform/fixform/save">
           ...
           <h4>             
                      ...
                      <div class="card-body">
                        <div class="form">
                          <p>地址</p>                          
                          <input name="address" class="form-control"  required value="" type="text" placeholder="" >
                        </div>
                        
                          
                         <div class="form">
                          <p>联系电话</p>                          
                          <input name="tel" class="form-control"  required value="" type="text" placeholder="" >
                        </div>
                        
                         <div class="form">
                          <p>申请人</p>                          
                          <input name="username" class="form-control" required value="" type="text" placeholder="" >
                        </div>
