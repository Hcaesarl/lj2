...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-pencil"></span> 更新新闻信息
                    </div>
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="<%=basePath %>news/news/update" method="POST">
                                <div class="am-form-group">
                                 ...
                                 <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">新闻封面</label>
                                    <div class="am-u-sm-9">
                                  ...
                                  <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">新闻简介</label>
                                    <div class="am-u-sm-9">
 ...
 <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">新闻内容</label>
                                    <div class="am-u-sm-9">
